...
namespace APIVerve.API.TexttoEmoji
{
    ...
    /// <summary>
    /// Client for the TexttoEmoji API
    /// </summary>
    public class TexttoEmojiAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/texttoemoji";
        ...
        public TexttoEmojiAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TexttoEmojiAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TexttoEmojiAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TexttoEmojiQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(TexttoEmojiQueryOptions options)
        {
        ...
        public ResponseObj Execute(TexttoEmojiQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(TexttoEmojiQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(TexttoEmojiQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(TexttoEmojiQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(TexttoEmojiQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(TexttoEmojiQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(TexttoEmojiQueryOptions options)
        {
