...
```gradle
dependencies {
    implementation 'com.github.apiverve:texttoemoji-api:1.1.14'
}
```
...
```java
import com.apiverve.texttoemoji.TexttoEmojiAPIClient;
import com.apiverve.texttoemoji.APIResponse;
import com.apiverve.texttoemoji.APIException;

// Initialize the client
TexttoEmojiAPIClient client = new TexttoEmojiAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("text", "I am so excited to go to the lake and swim");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/texttoemoji](https://docs.apiverve.com/ref/texttoemoji)
...
- **Documentation:** [https://docs.apiverve.com/ref/texttoemoji](https://docs.apiverve.com/ref/texttoemoji)
- **Issues:** [GitHub Issues](https://github.com/apiverve/texttoemoji-api/issues)
