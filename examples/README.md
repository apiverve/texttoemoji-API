# Text to Emoji API - Examples

This folder contains example code for using the Text to Emoji API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/texttoemoji',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/texttoemoji");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/texttoemoji](https://docs.apiverve.com/ref/texttoemoji)
